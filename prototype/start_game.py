"""
Simple starter script for Kelime Oyunu that doesn't rely on the app module structure.
This is especially useful if you're running into module import errors.
"""
...
def main():
    try:
        ...
        # Start the game app
        root = tk.Tk()
        app = KelimeOyunuApp(root, kolay_kelime, orta_kelime, zor_kelime)
        root.mainloop()
...
class KelimeOyunuApp:
    def __init__(self, root, kolay_kelime, orta_kelime, zor_kelime):
        self.root = root
    ...
    def joker_detay_ac(self):
        ...
        # Update description with details instead of showing popup
        current_desc = self.aciklama_label.cget('text')
